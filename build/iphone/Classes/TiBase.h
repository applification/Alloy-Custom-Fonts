...
// in simulator we redefine to format for Alloy_Custom_Fonts Developer console
...
{\
	NSString * exceptionName = [@"org.alloy_custom_fonts." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.alloy_custom_fonts";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIAlloy_Custom_FontsNativeItemNone = -1, 
	UIAlloy_Custom_FontsNativeItemSpinner = -2,
	UIAlloy_Custom_FontsNativeItemProgressBar = -3,
	
	UIAlloy_Custom_FontsNativeItemSlider = -4,
	UIAlloy_Custom_FontsNativeItemSwitch = -5,
	UIAlloy_Custom_FontsNativeItemMultiButton = -6,
	UIAlloy_Custom_FontsNativeItemSegmented = -7,
	
	UIAlloy_Custom_FontsNativeItemTextView = -8,
	UIAlloy_Custom_FontsNativeItemTextField = -9,
	UIAlloy_Custom_FontsNativeItemSearchBar = -10,
	
	UIAlloy_Custom_FontsNativeItemPicker = -11,
	UIAlloy_Custom_FontsNativeItemDatePicker = -12,
	
	UIAlloy_Custom_FontsNativeItemInfoLight = -13,
	UIAlloy_Custom_FontsNativeItemInfoDark = -14,
	
	UIAlloy_Custom_FontsNativeItemDisclosure = -15,
	
	UIAlloy_Custom_FontsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Alloy_Custom_Fonts instances of
