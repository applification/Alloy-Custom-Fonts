...
@interface Alloy_Custom_FontsObject : KrollCoverageObject {
#else
@interface Alloy_Custom_FontsObject : KrollObject {
#endif
@private
...
extern NSString * Alloy_Custom_Fonts$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Alloy_Custom_FontsObject *_alloy_custom_fonts;
    KrollObject* console;
	BOOL shutdown;
