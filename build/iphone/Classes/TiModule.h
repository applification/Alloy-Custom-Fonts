...
/**
 The base class for all Alloy_Custom_Fonts modules
 */
...
/**
 Alloy_Custom_Fonts Platform calls this method on startup.
 */
-(void)startup;

/**
 Alloy_Custom_Fonts Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Alloy_Custom_Fonts Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Alloy_Custom_Fonts Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Alloy_Custom_Fonts Platform calls this method on resume.
 @param sender The sender of the event.
 */
