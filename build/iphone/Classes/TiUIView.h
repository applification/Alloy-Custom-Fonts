...
/**
 Base class for all Alloy_Custom_Fonts views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Alloy_Custom_Fonts view hierarchy (such as wrapped iOS UIViews) was touched.
