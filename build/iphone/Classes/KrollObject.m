...
//@interface Alloy_Custom_FontsObject : NSObject
//@end

@interface Alloy_Custom_FontsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Alloy_Custom_FontsObject class]])
		{
			for (NSString *key in [[(Alloy_Custom_FontsObject*)o modules] allKeys])
			{
