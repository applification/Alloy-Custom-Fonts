...
static NSString * const kAlloy_Custom_FontsJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_alloy_custom_fontsInjection
{
	...
	[html appendString:kAlloy_Custom_FontsJavascript];
...
{
	// attempt to make well-formed HTML and inject in our Alloy_Custom_Fonts bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _alloy_custom_fontsInjection]];
