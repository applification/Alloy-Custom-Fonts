...
//Rare exceptions to indicate a bug in the _alloy_custom_fonts code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Alloy_Custom_Fonts proxies.
 */
